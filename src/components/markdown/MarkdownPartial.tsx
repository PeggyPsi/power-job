...
/*
This is a component that handles overflowing text.
That means that when the markdown text overflows, on the screnn a "Read More"
button appears which opens a dialog in which the user can read the whole text without it being truncated
*/
