...
import { userNoticationSettingsSchema } from "../actions/schemas";
import z from "zod";
import {
  Form,
  FormControl,
...
export function NotificationsForm({
  ...
  const form = useForm({
    resolver: zodResolver(userNoticationSettingsSchema),
  ...
  async function onSubmit(data: z.infer<typeof userNoticationSettingsSchema>) {
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        ...
                        value={field.value ?? ""}
                        className="min-h-32"
                        placeholder="Describe the jobs you're interested in. For example: 'I'm lokking for remote frontend development positions that us React and pay at least $100k per year.'"
                      />
                    </FormControl>
                    <FormDescription>
